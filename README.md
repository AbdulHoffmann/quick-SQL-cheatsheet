...
Source: [w3s SQL Reference](https://www.w3schools.com/sql/sql_intro.asp)
...
> #### Additional use 3: aliasing table names (Oracle doesnt use `AS`, it just put the letter after the table_name)
